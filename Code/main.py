...
from Calculator import Pension, Simple_pension, Guaranteed_pension, Instalment_pension

my_company = Company(name="Sagalsie", interest=0.075, risk_level=0, fund_data="Code/Data/Saglasie_fund_actives.csv")
